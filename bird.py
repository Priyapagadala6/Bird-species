...
model_path = 'chillimodelpred72.h5'  # Ensure the model file is uploaded to the same directory
label_file_path = 'bird_names.txt'  # Ensure the labels file is uploaded to the same directory
